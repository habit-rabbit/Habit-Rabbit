...
//finds the table that is required for a database query based on the restful route that calls this function;
function findTable(url) {
  ...
  //returns the last possibilitty as it's more likely the desired table.
